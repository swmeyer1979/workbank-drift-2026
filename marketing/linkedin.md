...
I recomputed the capability axis against the April-2026 frontier — Codex OAuth GPT-5.5 xhigh, Kimi K2.6, OpenAI GPT-5.5 — held worker desire fixed at its 2025 value, and looked at what migrated.

**The framework collapsed.**

In 2025, 75% of tasks scored above the capability threshold. In April 2026, **97.3%** do. The R&D Opportunity zone dropped from 107 tasks to 12. Low Priority dropped from 106 to 7.

24% of tasks moved zones. Two flows dominate: 94 tasks moved from R&D Opportunity to Green Light (workers wanted help, capability now arrived), and 101 moved from Low Priority to Red Light (workers didn't want help, capability arrived anyway).
